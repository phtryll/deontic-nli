...
my_rules_cfg = [
    ...
    Rule(left="S", right=["[Hypothesis]", "DEONTIC_AFFIRMATION", "."], prob=0.34),
    Rule(left="S", right=["[Premise]", "COMPOUND_PREMISE", "."], prob=0.33),
    ...
    Rule(left="p", right=["NAME", "VERB", "in", "COUNTRY"]),
    Rule(left="q", right=["NAME", "VERB", "in", "CITY"]),
